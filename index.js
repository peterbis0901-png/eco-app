...
// Backend AI Chatbot API (Mô phỏng tư vấn tâm lý lo âu/Hiệu ứng Spotlight)
...
// 2. FRONTEND (GIAO DIỆN SỔ TAY PHẢN TƯ + SPOTLIGHT CHECK)
app.get('/', (req, res) => {
    const htmlContent = `
    <!DOCTYPE html>
    <html lang="vi">
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; font-family: system-ui, -apple-system, sans-serif; }
            ...
            /* Slider */
            .slider-container { text-align: center; margin: 1rem 0; }
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="nav-tabs">
                <button class="tab-btn active" onclick="switchTab('journal')">📖 Sổ Tay</button>
                <button class="tab-btn" onclick="switchTab('chatbot')">🤖 AI Chat</button>
                <button class="tab-btn" onclick="switchTab('challenge')">🏆 Thử Thách</button>
                <button class="tab-btn" onclick="switchTab('support')">📞 Hỗ Trợ</button>
            </div>
