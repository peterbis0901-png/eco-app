...
// API AI Chatbot - Tích hợp xử lý tư vấn tâm lý
...
app.post('/api/predict-spotlight', (req, res) => {
    try {
        ...
        setTimeout(() => {
            res.json({ success: true, perceivedPercent: perceived, predictedPercent: predictedActual, explanation, reframes });
        }, 400);
    } catch (err) {
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: system-ui, -apple-system, sans-serif; }
        ...
        textarea, input[type="text"] { width: 100%; padding: 0.8rem; border: 1px solid #cbd5e1; border-radius: 12px; font-size: 0.88rem; margin-bottom: 0.9rem; outline: none; transition: border 0.2s; resize: vertical; }
...
<body>
    ...
    <div class="container">
        ...
        <!-- TAB 4: BỨC TƯỜNG ĐỒNG CẢM ẨN DANH -->
        ...
        async function postToWall() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    loadWall(); // Load lại bức tường ngay lập tức
                }
            } catch(e) {
